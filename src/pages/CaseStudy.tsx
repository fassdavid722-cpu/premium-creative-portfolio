...
export default function CaseStudy() {
  ...
  return (
    <main className="pt-20">
      ...
      {/* Creative Direction */}
      <section className="py-16" style={{ background: 'rgba(4,57,92,0.3)' }}>
        <div className="container-arch max-w-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {project.process.map((step, i) => (
              <motion.div key={i} {...fadeUp} transition={{ delay: i * 0.12 }}>
                <div className="heading-serif text-6xl font-bold opacity-10 mb-2">0{i + 1}</div>
      ...
      {/* Gallery */}
      <section className="py-16" style={{ background: 'rgba(2,30,49,0.6)' }}>
        <div className="container-arch">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {project.gallery.map((img, i) => (
              <motion.div key={i} {...fadeUp} transition={{ delay: i * 0.1 }}
                className="rounded-2xl overflow-hidden border border-white/5 hover:border-teal/20 transition-all">
        ...
        <div className="container-arch">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {project.results.map((r, i) => (
              <motion.div key={i} {...fadeUp} transition={{ delay: i * 0.1 }}
                className="card-arch p-8 text-center hover:border-teal/20">
      ...
      <section className="py-16">
        <div className="container-arch">
          <div className="relative overflow-hidden rounded-3xl p-12 md:p-16 text-center border"
            style={{ borderColor: 'rgba(0,206,202,0.2)', background: 'linear-gradient(135deg, rgba(0,206,202,0.07) 0%, rgba(3,47,76,0.5) 100%)' }}>
