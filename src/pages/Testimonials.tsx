      ...
      <div className="container-arch relative z-10">
        <div className="text-center mb-16">
          ...
          <h1 className="heading-serif text-5xl md:text-6xl font-bold mb-4">
            Real Words. <span className="text-accent-grad">Real Clients.</span>
          </h1>
        ...
        <motion.div {...fadeUp} className="glass-panel p-12 md:p-16 mb-10 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex justify-center gap-1 mb-5">
              {[...Array(5)].map((_, i) => <Star key={i} size={22} style={{ color: '#c5f74f', fill: '#c5f74f' }} />)}
            </div>
            ...
            <div className="flex items-center justify-center gap-4">
              <img src={testimonials[0].avatar} alt={testimonials[0].name}
                className="w-14 h-14 rounded-full object-cover border-2" style={{ borderColor: '#c5f74f' }} />
              <div className="text-left">
                ...
                <p className="text-xs mt-0.5" style={{ color: '#c5f74f' }}>Hired for: {testimonials[0].service}</p>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          {testimonials.slice(1).map((t, i) => (
            <motion.div key={t.id} {...fadeUp} transition={{ delay: i * 0.1 }}
              ...
              <div className="flex gap-1 mb-4">
                {[...Array(5)].map((_, j) => <Star key={j} size={14} style={{ color: '#c5f74f', fill: '#c5f74f' }} />)}
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: '#c5f74f' }}>{t.service}</p>
                </div>
              </div>
            </motion.div>
          ))}
