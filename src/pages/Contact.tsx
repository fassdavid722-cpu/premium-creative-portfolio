    ...
    <main className="pt-32 pb-24">
      <div className="container-arch">
        <motion.div
          ...
          className="text-center mb-14" style={{ transformStyle: 'preserve-3d' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <form onSubmit={submit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input type="text" required value={form.name} onChange={e => up('name', e.target.value)}
                      ...
                      className="w-full px-4 py-3 rounded-xl text-sm text-white placeholder:text-white/25 focus:outline-none border transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <select required value={form.service} onChange={e => up('service', e.target.value)}
                      className="w-full px-4 py-3 rounded-xl text-sm text-white focus:outline-none border transition-all"
                ...
                <div>
                  ...
                  <textarea required rows={5} value={form.message} onChange={e => up('message', e.target.value)}
                    ...
                    className="w-full px-4 py-3 rounded-xl text-sm text-white placeholder:text-white/25 focus:outline-none border transition-all resize-none"
                    style={{ background: 'rgba(4,57,92,0.4)', borderColor: 'rgba(255,255,255,0.08)' }}
                    onFocus={e => e.currentTarget.style.borderColor = 'rgba(0,206,202,0.4)'}
                    onBlur={e => e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'} />
                </div>
          ...
          <div className="space-y-5">
            <motion.div
              ...
              <TiltCard intensity={5}>
                <a href="https://wa.me/2348000000000?text=Hi%20Daniels%2C%20I%27d%20like%20to%20discuss%20a%20project%20with%20Archworks"
                  ...
                  className="flex items-center gap-4 p-5 rounded-2xl border hover:border-teal/30 transition-all group depth-shadow"
                  style={{ background: 'rgba(37,211,102,0.08)', borderColor: 'rgba(37,211,102,0.15)' }}>
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ background: 'rgba(37,211,102,0.15)', transform: 'translateZ(20px)' }}>
            ...
            <motion.div
              ...
              <TiltCard intensity={5}>
                <a href="mailto:archdaniels101@gmail.com"
                  ...
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ background: 'rgba(0,206,202,0.1)', transform: 'translateZ(20px)' }}>
            ...
            <motion.div
              ...
              <TiltCard intensity={5}>
                <div className="card-arch p-5 depth-shadow">
                  <p className="text-xs font-semibold uppercase tracking-wider text-white/40 mb-4" style={{ transform: 'translateZ(15px)' }}>Follow Archworks</p>
                  <div className="space-y-3">
                    {socials.map(({ Icon, label, href, note }) => (
                      <a key={note} href={href} target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-3 text-white/50 hover:text-white transition-colors group">
                        <div className="w-8 h-8 rounded-lg flex items-center justify-center border border-white/10 group-hover:border-teal/30 transition-all"
            ...
            <motion.div
              ...
              style={{ transformStyle: 'preserve-3d' }}>
              <TiltCard intensity={5}>
                <div className="card-arch p-5 depth-shadow" style={{ borderColor: 'rgba(0,206,202,0.15)' }}>
                  <p className="font-semibold text-white text-sm mb-1" style={{ transform: 'translateZ(15px)' }}>⚡ Fast Response</p>
